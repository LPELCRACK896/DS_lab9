...
AFRICA = ['Algeria', 'Angola', 'Benin', 'Botswana', 'Burkina Faso', 'Burundi', 'Cabo Verde', 'Cameroon',
          ...
          'Sudan', 'Tanzania', 'Togo', 'Tunisia', 'Uganda', 'Zambia', 'Zimbabwe', "Cape Verde", "Cote d'Ivoire",
          "Western Sahara","Swaziland","Saint Helena","Reunion","Mayotte","Democratic Republic of Congo", "Kenya"]
...
EUROPE = ['Albania', 'Andorra', 'Austria', 'Belarus', 'Belgium', 'Bosnia and Herzegovina', 'Bulgaria', 'Croatia',
          ...
          'Ukraine', 'United Kingdom', 'Vatican City', "Czechia",
          "Serbia and Montenegro","Gibraltar", "Latvia"]
...
NORTH_AMERICA = ['Antigua and Barbuda', 'Bahamas', 'Barbados', 'Belize', 'Canada', 'Costa Rica', 'Cuba', 'Dominica',
                 ...
                 'Trinidad and Tobago', 'United States', 'Anguilla', "Bermuda", "Cayman Islands",
                 "United States Virgin Islands","Turks and Caicos Islands","Saint Pierre and Miquelon","Puerto Rico","Netherlands Antilles","Montserrat","Greenland", "Guadeloupe", "Martinique"]

SOUTH_AMERICA = ['Argentina', 'Bolivia', 'Brazil', 'Chile', 'Colombia', 'Ecuador', 'Guyana', 'Paraguay', 'Peru',
                 'Suriname', 'Uruguay', 'Venezuela', 'Aruba',
                 "Falkland Islands","French Guiana"]

OCEANIA = ['Australia', 'Fiji', 'Kiribati', 'Marshall Islands', 'Nauru', 'New Zealand', 'Palau',
           'Papua New Guinea', 'Samoa', 'Solomon Islands', 'Tonga', 'Tuvalu', 'Vanuatu', "American Samoa", "British Virgin Islands",
           "Wallis and Futuna","Tokelau","Northern Mariana Islands","Niue","New Caledonia","Cook Islands", "French Polynesia","Guam", "Micronesia"]